"""Django settings for TeaWither-01."""
import os
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "dev-teawither-01-change-me-in-production",
)
...
INSTALLED_APPS = [
    ...
    "apps.gardens.apps.GardensConfig",
]
...
CSRF_TRUSTED_ORIGINS = [
    o.strip()
    for o in os.environ.get("CSRF_TRUSTED_ORIGINS", "http://localhost:4100,http://127.0.0.1:4100").split(",")
    if o.strip()
]
